...
- 주요 환경변수:
  ...
  - 선택: `DEEP_ANALYSIS=1`(글별 개별 심층분석 on), `FILTER_BODY_CHARS`, `DIGEST_MAX_TOKENS`, `ANALYZE_ALL`, `FILTER_FEEDBACK_BATCH`(하루 distill에 통합할 새 피드백 상한, 기본 120)

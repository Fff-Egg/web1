...
export const DEFAULT_IMPORTANCE_CRITERIA = `신뢰도와 중요도를 분리한다. 기업·산업의 수요·공급·가격·일정·정책·수급을 바꾸거나 다른 분야로 파급될 수 있으면 높음. 구체적인 찌라시·현장 전언·사회적 반대·병목 신호도 맞을 경우 함의가 크면 높음. 정보 증가분이 없는 광고·인사·일상·완전 동일 중복만 낮음. 애매하면 높음.`;

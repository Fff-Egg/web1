...
const SAMPLE_RESEARCH: ResearchList = {
  ...
  error: null,
  reports: [
    { id: 1, reportDate: "2026-06-20", category: "기업", title: "삼성전자 - HBM4 양산 가시화, 실적 모멘텀 회복", summary: "HBM4 양산이 앞당겨지며 메모리 실적 모멘텀이 회복, 목표주가 상향.", marketCap: 5134567e8, stockName: "삼성전자", stockCode: "005930", targetPrice: "95,000", opinion: "매수", broker: "미래에셋증권", pdfUrl: "https://example.com/r1.pdf", coverageCount: 7, isMajor: true, tpRaised: true },
    { id: 2, reportDate: "2026-06-20", category: "기업", title: "SK하이닉스 - DRAM 가격 반등 본격화", summary: "DRAM 현물가 반등이 본격화되며 하반기 이익 추정치 상향 여지.", marketCap: 1623400e8, stockName: "SK하이닉스", stockCode: "000660", targetPrice: "240,000", opinion: "매수", broker: "한국투자증권", pdfUrl: "https://example.com/r2.pdf", coverageCount: 5, isMajor: true, tpRaised: false },
    { id: 3, reportDate: "2026-06-20", category: "기업", title: "현대차 - 하반기 신차 사이클 점검", summary: "하반기 신차 출시로 믹스 개선 기대, 단 환율 변동성은 부담.", marketCap: 543000e8, stockName: "현대차", stockCode: "005380", targetPrice: "270,000", opinion: "매수", broker: "NH투자증권", pdfUrl: "https://example.com/r3.pdf", coverageCount: 2, isMajor: false, tpRaised: false },
    { id: 4, reportDate: "2026-06-20", category: "산업", title: "반도체 - 메모리 업황 회복 사이클 진입", summary: "감산 효과와 AI 수요로 메모리 업황이 회복 사이클에 진입.", marketCap: null, stockName: null, stockCode: null, targetPrice: null, opinion: null, broker: "키움증권", pdfUrl: "https://example.com/r4.pdf", coverageCount: 0, isMajor: false, tpRaised: false },
    { id: 5, reportDate: "2026-06-20", category: "시황", title: "주간 시황 - 금리 인하 기대와 환율 변동성", summary: "금리 인하 기대가 유효하나 환율 변동성이 지수 발목을 잡는 국면.", marketCap: null, stockName: null, stockCode: null, targetPrice: null, opinion: null, broker: "삼성증권", pdfUrl: "https://example.com/r5.pdf", coverageCount: 0, isMajor: false, tpRaised: false },
  ],
};
